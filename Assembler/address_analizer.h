...
char* analize_operands(dictionary* operation_table, address_entries* d_i, char* operation_name, char* current_line, symbol_table* s_t, dictionary* registers_dict, int L);
